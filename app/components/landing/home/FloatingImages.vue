<template>
  ...
  <span class="absolute top-[28%] right-[36%]">
          <NuxtImg
            class="size-10 align-middle"
            ...
            alt="img1"
        /></span>
        <span class="absolute left-[41.3%] top-[36%]">
          <NuxtImg
            class="size-10 align-middle"
        ...
        <span class="absolute left-[45%] bottom-[18%]">
          <NuxtImg
            class="size-10 align-middle"
        ...
        <span class="absolute top-[56%] right-[40%]"
          ><NuxtImg
            class="size-10 align-middle"
            src="data:image/svg+xml,%3csvg%20width='43'%20height='42'%20viewBox='0%200%2043%2042'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M11.8398%200C-0.443787%2011.5373%20-4.19132%2022.8667%205.48979%2033.5724C16.7324%2045.9412%2029.0159%2042.8229%2042.2364%2027.4399C30.6815%2017.046%2021.5209%208.73089%2011.8398%200Z'%20fill='%23B2EDA1'%20fill-opacity='0.3'/%3e%3c/svg%3e"
            alt="img4"
        /></span>
        <span class="absolute left-[25%] bottom-[13%]">
          <NuxtImg
            class="size-10 align-middle"
            ...
            alt="img5"
        /></span>
        <span class="absolute top-[18%] let-[25%]"
          ><NuxtImg
            class="size-10 align-middle"
        ...
        <div class="container mx-auto hidden sm:block">
          <span class="absolute h-[40%] top-8 right-[34.1%] z-3"
            ><NuxtImg
              ...
              alt="img"
          /></span>
          <span class="absolute h-[60%] -bottom-0.75 right-[38%] z-0"
            ><NuxtImg
              class="h-full w-full align-middle"
